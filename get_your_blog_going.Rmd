...
- Themes exist here: In `config/_default/params` set a new [theme](https://sourcethemes.com/academic/themes/) by using theme = "_"
- In `content/home`:
    - Set “hero” widget (top-most banner) to `active = false` (don't delete)
